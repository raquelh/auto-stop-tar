...
def autotar_method(data_name, topic_set, topic_id,
                   ...
                   stopping_percentage=1.0, stopping_recall=0.6,  # autostop parameters, for debug
    ...
    """
    '''
    ver como transforma o json em lista
    ...
    with open(interaction_file, 'w', encoding='utf8') as f:
        ...
        while not stopping:
            ...
            # statistics
            #sample num é o número de arquivos que ele acessou
    ...
    return
#topic ID - 
#topic_set string de busca
#query_file CD008122	0	15361993	1
#doc_id_file lista de ids
#doc_text_file json de arquivos 
if __name__ == '__main__':
    ...
    autotar_method(data_name, topic_id, topic_set, qrel_file, doc_id_file, doc_text_file)