...
from tar_framework.sampling_estimating import HTUniformSampler, HTMixtureUniformSampler, HTPowerLawSampler, HTAPPriorSampler, \
...
def autostop_method(data_name, topic_set, topic_id,
                    ...
                    stopping_percentage=None, stopping_recall=0.9, target_recall=1.0, stopping_condition='loose', # autostop parameters
                    random_state=0):
...
def autostop_for_large_collection(data_name, topic_set, topic_id,
        qrel_files, doc_id_files, doc_text_files,  # data parameters
        sampler_type='HTAPPriorSampler', epsilon=0.5, beta=-0.1,
    ...
    total_shown_dids = []
    for  qrel_file, doc_id_file, doc_text_file in zip( qrel_files, doc_id_files, doc_text_files):
...
if __name__ == '__main__':
    ...
    autostop_method(data_name, topic_id, topic_set, qrel_file, doc_id_file, doc_text_file)