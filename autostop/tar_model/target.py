...
def target_method(data_name, topic_set, topic_id,
                  qrel_file, doc_id_file, doc_text_file,  # data parameters
                   stopping_percentage=None, stopping_recall=0.9,  # autostop parameters
        ...
        while not stopping:
            ...
            if stopping_recall:
                if running_true_recall >= stopping_recall:
                    print('stop recall', running_true_recall)
                    stopping = True
...
if __name__ == '__main__':
    ...
    target_method(data_name, topic_id, topic_set, qrel_file, doc_id_file, doc_text_file)